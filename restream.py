...
# HTML TEMPLATES
# ============================================================
# WATCH_HTML, HOME_HTML, LIST_HTML, SEARCH_HTML, FAV_HTML
# ... Keep the previous templates, just update buttons:
# - LIST/SEARCH/FAV pages use `/stream-144p/...` instead of audio
# - WATCH page defaults to 144p streaming
# (No audio-only buttons anywhere)
